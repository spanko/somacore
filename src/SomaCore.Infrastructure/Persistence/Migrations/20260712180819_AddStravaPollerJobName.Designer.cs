...
namespace SomaCore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260712180819_AddStravaPollerJobName")]
    partial class AddStravaPollerJobName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SomaCore.Domain.JobRuns.JobRun", b =>
                {
                    ...
                    b.ToTable("job_runs", null, t =>
                        {
                            t.HasCheckConstraint("chk_job_runs_job_name", "job_name IN ('reconciliation-poller', 'token-refresh-sweeper', 'strava-reconciliation-poller')");
                        });
                });
