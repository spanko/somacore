...
namespace SomaCore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260522033017_AddWhoopSleepsAndWorkouts")]
    partial class AddWhoopSleepsAndWorkouts
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("whoop_sleeps", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_whoop_sleeps_ingested_via", "ingested_via IN ('webhook', 'poller', 'on_open_pull')");
                    ...
                    b.ToTable("whoop_workouts", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_whoop_workouts_ingested_via", "ingested_via IN ('webhook', 'poller', 'on_open_pull')");
